...
<head>
    ...
    <style>
        ...
        .register-container { /* Changed class name to register-container */
        ...
        form input[type="email"] { /* Added email input type */
        ...
        p { /* Styling for "Already have an account?" paragraph */
            margin-top: 25px;
            font-size: 1em;
            color: #666;
        }

        p a { /* Styling for Login link */
            color: #007bff;
...
<body>
    <div class="register-container">
        ...
        <form action="/register" method="post">
            ...
            <input type="password" id="password" name="password" required /><label for="email">Email:</label>
            <input type="email" id="email" name="email" required /><input type="submit" value="Register" />
        </form>
